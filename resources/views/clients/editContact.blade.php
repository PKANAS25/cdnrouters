...
<div id="content" class="content">
            ...
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header">{{ $contact->name }} <small> Edit</small></h1>
            <!-- end page-header -->
            <!-- begin row -->
             <div class="col-md-12">
                    <!-- begin panel -->
                            ...
                            <form name="eForm" id="eForm"  method="POST" autocomplete="OFF" class="form-horizontal form-bordered"  enctype="multipart/form-data"  data-fv-framework="bootstrap"  data-fv-message="Required Field"  data-fv-icon-invalid="glyphicon glyphicon-remove"  data-fv-icon-validating="glyphicon glyphicon-refresh">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="name"   name="name" data-fv-notempty="true"   value="{{ $contact->name }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select class="form-control"  name="position" data-fv-notempty="true">
                                            <option value="{{ $contact->position }}">{{ $contact->desig }}</option> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="mobile"  name="mobile" data-fv-notempty="true"  data-fv-digits="true" value="{{ $contact->mobile }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="phone"  name="phone"   data-fv-digits="true" value="{{ $contact->phone }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="phone2"  name="phone2"  data-fv-digits="true"  value="{{ $contact->phone2 }}" />
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" id="email"   name="email"    data-fv-emailaddress="true"   data-fv-emailaddress-message="The value is not a valid email address"  value="{{ $contact->email }}" />
                                    </div>
                                </div> 
