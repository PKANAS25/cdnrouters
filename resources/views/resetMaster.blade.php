...
<head>
	...
	<!-- ================Formavalidation.io========================= -->
	<link rel="stylesheet" href="/hr_assets/dist/css/formValidation.css"/>

    
   <!-- <script type="text/javascript" src="/hr_assets/dist/bootstrap/js/bootstrap.min.js"></script>-->
    <script type="text/javascript" src="/hr_assets/dist/js/formValidation.js"></script>
    <script type="text/javascript" src="/hr_assets/dist/js/framework/bootstrap.js"></script>
    <!-- =========================================================================== -->
...
<body>
	...
	<script src="/hr_assets/js/dashboard-v2.min.js"></script>
